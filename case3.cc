...
C    Generated on Fri Mar  3 17:35:58 2023
...
C    Thermophysical Property Database: ThermalData.tdp
...
C    hrIllum              0.            0
C    hrMeanAnom           29.98306      2.998306260771e+01  
...
C    hrPlanetY            -5.551120e-17 -5.55112e-17
C    hrPlanetZ            1.            1
C    hrPos                1.            1
...
C    hrTime               464.585       464.585              Always in current user units. If programming, use hrTime...
C    hrTimeSec            464.585       464.585
