...
echo Running task '"C:\Program Files\Cullimore and Ring\Thermal Desktop\radcad_cl64.exe" "EXTERNAL_HR-Cold_Case-rcoptics_open_v1.3 (2).rch" 1 Y 0'...
SET /A tasks = %tasks% + 1
"C:\Program Files\Cullimore and Ring\Thermal Desktop\radcad_cl64.exe" "EXTERNAL_HR-Cold_Case-rcoptics_open_v1.3 (2).rch" 1 Y 0
if %errorlevel% == 0 (
    echo   Success
) else (
